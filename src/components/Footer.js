        ...
        <div className="container mx-auto flex flex-col md:flex-row justify-between items-start md:items-center">
          ...
          <div className="mb-6 md:mb-0 text-center md:text-left">
            ...
            <ul className="space-y-2">
              ...
              <li>Mobile: <a href="tel:9569862364" className="text-primary">9569862364</a></li>
              <li>Email: <a href="mailto:singhsabhishek23@gmail.com" className="text-primary">singhsabhishek23@gmail.com</a></li>
            </ul>
          </div>
          ...
          <nav className="mb-6 md:mb-0 text-center md:text-left">
            ...
            <ul className="space-y-2">
              <li><a href="/about" className="link link-hover text-primary">About Us</a></li>
              <li><a href="/skills" className="link link-hover text-primary">Skills</a></li>
              <li><a href="/jobs" className="link link-hover text-primary">Jobs</a></li>
              <li><a href="/contact" className="link link-hover text-primary">Contact</a></li>
            </ul>
          </nav>
